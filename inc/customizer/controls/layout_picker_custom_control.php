        ...
        public function render_content()
           {
            ...
            <div class="layout-customizer-control">
                <label>
                    ...
                    <img src="<?php echo $imageDirectory; ?>left_sidebar.png" alt="<?php _e('Left Sidebar', 'utalk'); ?>" />
                    <span><?php _e('Left Sidebar', 'utalk'); ?></span>
                </label>
                <label>
                    <input type="radio" value="2" name="<?php echo esc_attr( $this->id ); ?>" <?php $this->link(); checked( $this->value(), "right_sidebar"); ?> />
                    <img src="<?php echo $imageDirectory; ?>right_sidebar.png" alt="<?php _e('Full Width', 'utalk'); ?>" />
                    <span><?php _e('Right Sidebar', 'utalk'); ?></span>
                </label>
                <label>
                    <input type="radio" value="3" name="<?php echo esc_attr( $this->id ); ?>" <?php $this->link(); checked( $this->value(), "full_width"); ?> />
                    <img src="<?php echo $imageDirectory; ?>full_width.png" alt="<?php _e('Full Width', 'utalk'); ?>" />
                    <span><?php _e('Full Width', 'utalk'); ?></span>
                </label>
            </div>
        <?php }
    }
